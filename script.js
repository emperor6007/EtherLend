...
async function showEthBalanceStatus(address) {
  ...
  if (balance === null) {
    ...
    if (boxEl) {
      ...
      if (msgEl) {
        msgEl.className = 'eth-qualify-msg eth-qualify-neutral';
        msgEl.innerHTML = `ℹ️ Could not fetch balance. Ensure you have ETH in your wallet to boost your loan approval chances.`;
      }
    }
    return;
  }
  ...
  if (msgEl) {
    if (balance > 0) {
      ...
      msgEl.innerHTML = `⚠️ <strong>No ETH detected</strong> in your wallet. To boost your chances of loan approval, please <strong>deposit ETH</strong> into your wallet before applying.`;
    }
  }
}
